<template>
  ...
  <div id="user">
    ...
    <select type="text" style="font-size: 36px; left: 960px; top: -90px; text-align: center;" placeholder="" list="typelist" v-model="username">
    ...
    <button type="primary" style="font-size: 36px; top: -20px; left: 696px;" @click="Login">Log in</button>
  </div>
  ...
  <div id="imgcontent" style="display:none">
    ...
    <p style="top: -135px; left: -10px; font-size: 33px; color: coral">Welcome! {{username}}</p>
